          ...
          {sessions
            ...
            .map((sess) => (
              <div className="border-gray-600  border m-2 p-2 rounded shadow text-left flex flex-col sm:flex-row sm:flex-wrap ">
                <div className="w-full sm:w-1/2 pl-4 flex py-4 text-green-700 text-bold text-lg">
                  <svg
                  ...
                  <div className="">
                    <Link to={`/clients/${sess.client._id}`}>
                      <div className="">
                        Client: {sess.client.fname} {sess.client.lname}
                      </div>
                    </Link>
                  </div>
                </div>
                <div className="w-full sm:w-1/2 pl-4 flex py-4 text-green-700 text-bold text-lg">
                  ...
                  <div className="">
                    <Link to={`/Therapists/${sess.Therapist._id}`}>
                      <div className="">
                        Therapist: {sess.Therapist.fname} {sess.Therapist.lname}
                      </div>
                    </Link>
                  </div>
                </div>
