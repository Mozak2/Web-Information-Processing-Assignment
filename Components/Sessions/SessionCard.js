        ...
        <div className="flex flex-col justify-between">
          <div className="border-gray-600  border m-2 p-2 rounded shadow text-left flex flex-col sm:flex-row sm:flex-wrap ">
            ...
            <div className="w-full sm:w-1/2 pl-4 flex py-4 text-black font-bold text-lg">
              ...
              <div className="">
                <Link to={`/Therapists/${session.Therapist._id}`}>
                  <div className="">
                    Therapist: {session.Therapist.fname} {session.Therapist.lname}
                  </div>
                </Link>
              </div>
            </div>
            ...
            <div className="w-full pl-4 flex justify-between py-2">
              <div className="flex justify-between w-10/12">
                ...
                <div className="w-10/12">
                  ...
                  >
                    <div className="bg-red-400 py-3 px-2 flex rounded-xl shadow-lg w-full">
                      <svg
                        className="w-6 h-6 mr-2"
                        fill="none"
                        stroke="currentColor"
