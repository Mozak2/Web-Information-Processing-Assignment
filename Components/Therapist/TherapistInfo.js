...
const TherapistInfo = ({ Therapist }) => {
  return (
    <div className="mx-2 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 flex justify-start items-start bg-yellow-200 px-3 py-2 my-2 w-10/12 sm:w-80">
      <div className="pr-4">
        <svg
          className="w-16"
          fill="none"
      ...
      <div className="flex flex-col w-2/3">
        ...
        <Link
          to={{
            pathname: `/Therapists/${Therapist._id}`,
            state: { Therapist },
          }}
        >
